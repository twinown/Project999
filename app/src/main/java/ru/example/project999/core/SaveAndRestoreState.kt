...
//в целом, вот она и есть,да. дальше посмотрим в тестах, как это реализуется
...
interface SaveAndRestoreState {
    ...
    abstract class Abstract<T : Serializable>(
        ...
        //этот метод сохраняет в бандл твой кэш, сериалайзбл - то есть ты туда можешь положить любое значение, реализующее
